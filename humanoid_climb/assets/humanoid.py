...
class Humanoid:
    ...
    def __init__(self, bullet_client, pos, ori, power, statefile=None, fixedBase=False):
        ...
        self.motor_power = [100, 200, 200]  # Increased abdomen_y and abdomen_x
        self.motor_names += ["right_hip_x", "right_hip_z", "right_hip_y", "right_knee"]
        self.motor_power += [100, 100, 400, 300]  # Increased right_hip_y and right_knee
        self.motor_names += ["left_hip_x", "left_hip_z", "left_hip_y", "left_knee"]
        self.motor_power += [100, 100, 400, 300]  # Increased left_hip_y and left_knee
        self.motor_names += ["right_shoulder1", "right_shoulder2", "right_elbow"]
        self.motor_power += [100, 100, 75]  # Increased shoulder powers
